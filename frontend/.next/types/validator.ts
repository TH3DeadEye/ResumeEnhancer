...
// Validate ../../app/api/resume/enhance/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/resume/enhance">> = Specific
  const handler = {} as typeof import("../../app/api/resume/enhance/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
